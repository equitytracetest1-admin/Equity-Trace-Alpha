    ...
    if (editTradeId !== null) {
      ...
      if (idx !== -1) {
        TRADES[idx] = { ...TRADES[idx],
          ...
          model: $('f-model').value || '',
          session: $('f-session').value || TRADES[idx].session || (typeof inferSessionFromESTTime === 'function' ? inferSessionFromESTTime(storedTime) : ''),
      ...
      const newTrade = {
        ...
        setup: $('f-setup').value || 'Custom',
        model: $('f-model').value || '',
        session: $('f-session').value || (typeof inferSessionFromESTTime === 'function' ? inferSessionFromESTTime(storedTime) : ''),
